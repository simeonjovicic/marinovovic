  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 flex items-end justify-between gap-3 mt-auto w-full max-w-7xl mx-auto">
        ...
        <div className="text-right text-black select-none max-w-[60%] sm:max-w-xs md:max-w-md">
          <p className="text-sm sm:text-base md:text-2xl lg:text-3xl font-extrabold tracking-tight leading-tight uppercase hover:text-[#FF4D2D] transition-colors duration-300">
            KI-Berater
          </p>
          <p className="text-sm sm:text-base md:text-2xl lg:text-3xl font-extrabold tracking-tight leading-tight uppercase opacity-80 hover:text-[#FF4D2D] transition-colors duration-300">
            Dozent für KI
          </p>
          <p className="text-sm sm:text-base md:text-2xl lg:text-3xl font-extrabold tracking-tight leading-tight uppercase opacity-60 hover:text-[#FF4D2D] transition-colors duration-300">
            Mathematiker
          </p>
        </div>
      </div>
